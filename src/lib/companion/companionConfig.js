...
export const CHARACTER_MODELS={female:{id:"female",label:"Compañera",description:"Avatar femenino adulto",url:"/models/companion-female.fbx",format:"fbx"},male:{id:"male",label:"Compañero",description:"Avatar masculino adulto",url:"/models/companion-male.glb",format:"glb"}};
